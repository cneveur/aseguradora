...
<form id="registroSucursal" class="formulario registroSucursal">
    <fieldset>
        <div class="tituloFormulario"> <i class="fas fa-building"></i> modificar datos</div>
        <div class="subtituloFormulario"> <span class="sucursalNro"></span></div>
        ...
        <div class="row">
            ...
            <div class="col s4">
                ...
                <select class="select2" name="cpSucursal" id="cpSucursal"></select>
            </div>
            
            <div class="col s4">
                <label for="localidadSucursal">Localidad</label>
                <select class="select2" name="localidadSucursal" id="localidadSucursal"></select>
            </div>
        ...
        <div class="col s12 btnsNavSucursal">
            ...
            <button type="submit" class="btnSubmitSucursal btn-flat MAI green" id="submitModificarSucursal"> <i class="fas fa-save"></i> modificar</button>
        </div>
    </fieldset>
