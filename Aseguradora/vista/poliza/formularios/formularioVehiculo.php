...
<h2 class="tituloFormulario">datos del vehiculo</h2>
...
<div class="row">
  ...
  <div class="col s3">
    ...
    <select class="campo select2" id="select_marca" name="selec_marca">
  ...
  <div class="col s2">
    ...
    <input type="text" id="patente" class="campo" placeholder="ABC123 (Sin espacios)" maxlength="7" name="patente">
  </div>
...
<div class="row">
  ...
  <div class="col s4">
    <label for="select_uso">Uso</label>
...
<div class="row">
   ...
   <div class="col s1">
      ...
      <div class="switch">
        <label> <input type="checkbox" id="GPS" class="filled-in" name="GPS"> <span class="filled-in"></span> </label>
      </div>
   </div>
   ...
   <div class="col s1">
      ...
      <div class="switch">
        <label> <input type="checkbox" id="ceroKm" class="filled-in" name="ceroKm"> <span class="filled-in"></span> </label>
      </div>
   </div>
...
<div class="row">
  ...
  <div class="col s1">
    ...
    <div class="switch">
      <label> <input type="checkbox" id="eGas" class="filled-in" name="eGas"> <span class="filled-in"></span> </label>
    </div>
  </div>

  <div class="col s1">
    <label for="anio">Año</label>
    <input type="text" id="anio" class="campo" placeholder="2017" name="anio">
  </div>
