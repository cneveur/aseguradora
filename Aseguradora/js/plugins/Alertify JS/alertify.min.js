...
function configuracionAlert(tipo, nombreBtnAceptar, nombreBtnCancelar){

    if(nombreBtnCancelar==null || nombreBtnCancelar==''){
        nombreBtnCancelar = 'Atras';
    }else{
        nombreBtnCancelar = nombreBtnCancelar;
    }
    ...
    //Confirm
    }else if(tipo=='okCancel'){
        return { 
            transition:'fade',
            closable: false,
            movable:  false,
            labels: {ok:nombreBtnAceptar, cancel:nombreBtnCancelar}
        }
    ...
    //Prompt - Password
        ...
        return { 
            ...
            closable: false,
            movable:  false,
            labels: {ok:nombreBtnAceptar, cancel:'Atras'},
            type:'password'
        }
    }
}